...
A1: The top seven cities are Baltimore (6719), Bethesda (5868), Silver Spring (4658), Chevy Chase (3260), Potomac (2301), Rockville (2213) and Annapolis (2017. 
```{r}
...
A2: 20815 is chevy chase Maryland. It is a wealthy area. The committee "Angel for Maryland is the largest recipient of money from that zip code. Two of the top five recipients are from Maryland.

```{r}
new_city %>% 
group_by(contributor_zip) %>% 
summarise(contribution_receipt_amount, committee_name) %>% 
