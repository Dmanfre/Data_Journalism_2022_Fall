...
summarise(total = sum(contribution_receipt_amount)) %>% 
arrange(desc(total))
# PA received $12,145,267 in out-of-state contributions
# DC gave the most with $9,392,229.88 followed by NY and CA.
...
Something I've found interesting is that refunds are issued. As someone who was never really knowledgeable about campaign finance, the fact that you can eb issued a refund of your donation was thought-provoking. Both parties refunded a combined $14,212.96 to individual contributors.
```{r}
#looking for refunds
...
gop_dem_total_refund <- 13927.63+285.33
```
```{r}
