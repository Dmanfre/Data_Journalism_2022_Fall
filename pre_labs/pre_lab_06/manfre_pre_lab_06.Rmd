...
setwd("/Volumes/Elements/D-Drive/University of Maryland/Classes/Fall 2022/Data Journalism/Github Repository/Data_Journalism_2022_Fall/Pre_labs/Pre_lab_06/")
...
**Answer** I see a column that says x1, voters is a character field and not a number field as well as cast and turnout and there are NAs in rows. 
...
### First read the csv and cleaning names.
camden_2022 <- read_csv("tabula-camden_county_election_results.csv") %>% clean_names()

### renaming the x1 column to precinct.
###Then changing the voters column to a number column and changing turnout to become numberic while replacing the percent with blank.
...
### the second part of this changes the name of sunrise beach to add bend to it.
...
**Answer** We see 21 rows 

```{r}

### This filer will get rid of the rows with NA, in this case it is in cast.
