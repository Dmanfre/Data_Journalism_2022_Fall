...
#setwd(/Volumes/Elements/D-Drive/University of Maryland/Classes/Fall 2022/Data Journalism/Github Repository/Data_Journalism_2022_Fall/pre_labs/pre_lab_14)
...
**Answer** This has 4 columns and 999 rows.
...
**Answer** It seperates the words into lists. 
...
**Answer** Converts text to all lower case and then removes all punctuation. 
...
**Answer** The code produces a graph with the most unique words in the Cardin releases. 
...
**Answer** This isn't really much more interesting than before but it's a much cleaner dataset to work with. 
...
**Answer** The 2021 resutls have two words that are written over 1,000 times and with 2022, the word COVID didn't appear in the top 10. No word also appeared more than 1% of the total. 
```{r}
unique_words_2021 %>%
  anti_join(stop_words) %>%
  group_by(word) %>%
...
**Answer** This code combines the "non words" with the actual words such as COVID and 19 to make one word of COVID 19. It's a more realistic count.
...
**Task** Run the following code and describe the results.
**Answer** We see a combination of words that appear frequently together in the text such as COVID and 19. Now, the word COVID-19 has increased. This creates a more realistic list of what was actually said. 
...
**Answer** Safe is a word that can be incorrect because you can say safe but also not safe. This generates a variation of the words. 
