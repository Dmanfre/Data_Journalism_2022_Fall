...
setwd("/Volumes/Elements/D-Drive/University of Maryland/Classes/Fall 2022/Data Journalism/Github Repository/Data_Journalism_2022_Fall/pre_labs/pre_lab_05/")
...
**Answer** The second and third recipient are the same but the third has a period and the first doesn't.
...
**Answer** It changed Le Diplomate to only be one name in the recipient_clean column. 
...
**Answer** Got rid of the apostrophie in Walters sports bar, Changed Hilton Washington to Washington Hilton and Pizza We The became we the pizza. 
...
**Answer** I dont think they're that substantial because all they are changing are some commas and periods. We are able to see other obvious changes though.
...
recipient_clean <- read_csv("data/new_dc_food.csv")
