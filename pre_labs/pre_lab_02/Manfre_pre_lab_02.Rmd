...
setwd("/Volumes/Elements/D-Drive/University of Maryland/Classes/Fall 2022/Data Journalism/Github Repository/Data_Journalism_2022_Fall/pre_labs/pre_lab_02/")
```
...
**Answer** This data table shows the number of votes each candidate received on election day as a percent and is sorted by county. 
...
**Answer** It changed because it sorted the candidates by the percentage of votes they received on election day instead of just listing them in any order. There is also no other candidate who received 100% of his votes on election day specifically.
...
**Answer** These candidates have lower numbers on election day which means their votes come via absentee balloting or mail-in. The jurisdictions can also be coming from more different places. 
...
**Answer** str_to_lower is a function that will make your character column lower case. str_extract() is a function that will extract matching pairs from a string.
...
**Answer** In this table, we are creating amount categories based on the donations to the political candidates. The Mutate function is organizing the donations by a range of amounts, less than $100, between $100-500, between $501 and 2900 and over $2900.
...
**Answer** The largest category in terms of dollar amount is less than $100 which means that most people were not donating large amounts of money.
...
**Answer** This is important because it will keep our filtered and organized data together so that we can go back and look through it when we want to write our analysis about the data. 
...
**Answer:** This put it in a readable date format by going year-month-day.
...
**Answer** The value here is associated with the descending total amount. The code is then grouping it by the month.
