...
Then type this code to multiply the variable called number by itself.  4
...
**Answer**The code is sorting the contributions by date and showing you how many contributions happened on each date.
...
**Answer** The data is now sorted by the amount of county contributions where as in the previous cell block it was sorted by amount on each day.
...
Compared to the previous codeblock, what has changed and how did that affect the result?
**Answer** This table shows the number of contributions of a certain amount by a given organization as opposed to sorting the total number of contributions.
...
```
Compared to the previous codeblock, what has changed and how did that affect the result?
**Answer** This table shows the total number of donations made by each organization and the total dollar amount it adds up to. The previous tables showed the quantity of donations made in each dollar amount.
...
**Answer** This table has added the average donation made by each organization and it shows the median amount donated by each organization. I do not recognize any of the top names as p
...
**Answer** This codeblock shows the total amounts donated by each city and also shows the highest donation as well as the lowest. It is sorted by town and total amount. In this table, Bethesda, Md has donated the highest amount.
