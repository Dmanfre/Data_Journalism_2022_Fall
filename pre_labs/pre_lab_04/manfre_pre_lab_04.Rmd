...
setwd("/Volumes/Elements/D-Drive/University of Maryland/Classes/Fall 2022/Data Journalism/Github Repository/Data_Journalism_2022_Fall/pre_labs/pre_lab_04/")
...
**Answer** I did. Mission accomplished. This shows the total population in each county according to the census.
...
**Answer** He said do not do Task 9.

```{r}
# join on zip - but there's a problem
# REMEMBER THAT THE FRIST COLUMN IN A JOIN COMES FROM THE FIRST DATAFRAME IN A STATEMENT 
...
**Answer** Prince George's county has the highest Black population percentage over 18 and 78% of them are democrats. 
...
**Answer** Howard County has the highest percentage of Asians that are 18 or older at 19% and 52% of that percentage were democrats. These results are different becasue in Howard County there is a significantly smaller Black population.
...
**Answer** This has now become a character field.
