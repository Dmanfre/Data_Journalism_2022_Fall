...
setwd("/Volumes/Elements/D-Drive/University of Maryland/Classes/Fall 2022/Data Journalism/Github Repository/Data_Journalism_2022_Fall/pre_labs/pre_lab_10/")
...
## 3 statewide candidates on the ballot for republicans
```
...
**Answer** Copy the url of the graphic you published here. It will begin with
https://datawrapper.dwcdn.net/. Don't copy the browser's current url.

https://datawrapper.dwcdn.net/PVCi8/1/


```{r}
## PNG file
knitr::include_graphics("images/bargraphimage.png")
...
**What changed from the previous map is that you see just Maryland counties now as opposed to the whole map. There is also a much clearly defined gradiant.**
...
**Answer** Describe the changes from the previous map
**Here we see that there are no long percents. We see only what is defined in the format which is one number after the decemil.**
...
https://datawrapper.dwcdn.net/V6Mz8/1/

```{r}
## Image of the map

knitr::include_graphics("images/mapimage.png")
```
