...
setwd("/Volumes/Elements/D-Drive/University of Maryland/Classes/Fall 2022/Data Journalism/Github Repository/Data_Journalism_2022_Fall/Pre_labs/Pre_lab_07/")
...
**Answer** Nevada has the largest population percentage change between 2000-2010 with 35%.
...
**Answer** Howard County had highest median income. 
```{r}
...
### wide will make the columns more appropreate to work with. 
...
**Answer**
There is a differece but I would not call it significant.


Is the difference between Howard and everyone else significant?
**Answer**
Howard county and Montgomery county is significant as well as Harford county.
...
**Answer** I didn't see any of the median incomes fall. 

#### I'm kind of unsure what this question is really asking.
...
### This code generated the table based on the MoE
...
**Answer** None are less than 50,000. All of the estimates in md_zips_with_acs as well as top_zips have estimates north of 100,000.
...
**Answer** I think my first question would be where are these zip codes and then I'd be curious what type of demographic of people live there and if there is any influence there politically. 